...
import cn.knowbox.camera.options.GestureAction;
import cn.knowbox.camera.options.Grid;
...
import cn.knowbox.camera.utils.CameraLogger;
import cn.knowbox.camera.utils.CropHelper;
import cn.knowbox.camera.utils.OrientationHelper;
import cn.knowbox.camera.utils.WorkerHandler;
import cn.knowbox.camera.views.CameraPreview;
import cn.knowbox.camera.views.GestureLayout;
import cn.knowbox.camera.views.GridLinesLayout;
import cn.knowbox.camera.views.PinchGestureLayout;
import cn.knowbox.camera.views.ScrollGestureLayout;
import cn.knowbox.camera.views.SurfaceCameraPreview;
import cn.knowbox.camera.views.TapGestureLayout;
import cn.knowbox.camera.views.TextureCameraPreview;
